...
\todo{Rewrite the above to make it sound like an advantage, not a disadvantage.}
...
\todo{say:  in terms that end users understand}
...
\todo{Hard to parse:}By contrast, \ourtool eliminates \prevtool's assumption and
