...
\todo{add this paragraph to clarify reviewers' concern}
...
the time took by \ourtool to diagnose configuration errors in seconds.
...
\todo{make threats to validity more clear}
...
%% Here is how "12%" was calculated from the data of Figure~\ref{tab:experiment-sub}:
% (average
% (/ 1893 18571.0)
% (/ 1458  275035.0)
% (/ 1658  19153.0)
