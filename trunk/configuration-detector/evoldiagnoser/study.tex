...
software change analysis work~\cite{Ying:2004:PSC,
Zimmermann:2004, STVR:STVR1475, Dagenais:2008, Tao:2012:SEU,
deSouza:2008:ESS}, 
...
study from the subject programs in Figure~\ref{tab:subjects}.
}
}
\end{figure}
...
system. Apache~\cite{apache} has been the dominant
...
and searched for 5 keywords (``configuration option'',
...
a configuration option is changed. We collected
...
represents that fixing some bugs led to changes in
...
every version of each subject program (not shown in Figure~\ref{tab:options},
due to space limits).  
...
they might not apply to arbitrary programs.
