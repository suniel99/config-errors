...
To identify the root-cause configuration options,
%as the root causes, likelihood of each configuration
%option being the root cause,
...
%compute the number of executed statements controlled by a predicate,
...
If two configuration options have the
