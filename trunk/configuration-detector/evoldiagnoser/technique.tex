...
Second, the control flow differences between two execution
traces approximate the behavioral differences
of two versions; they provide evidence
about which parts of the program are behaving
abnormally and why.
%undesirably.
...
Then, \ourtool identifies the control flow differences between
the two execution traces produced by user demonstration.
...
%intuitive configuration logic
%and convey configuration knowledge to users
...
options for a behaviorally-deviated predicate. An alternative is to
use a pure
dynamic analysis to assess how a configuration option
may affect the control flow. 
