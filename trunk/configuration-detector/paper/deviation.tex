...
For an recorded predicate profile $p$, \ourtool uses the following $Deviation$ metric
...
$trueRatio(t, p)$ is a function that returns the ratio of the predicate $p$ being
...
based on the shortest distance from the initialization
...
to be the root cause and should be inspected first.
