...
and a single working state.
However, besides the difficulty in writing a good testing oracle,
a working state is often absent in practice since\todo{I don't understand
  the relationship between the text that precedes ``since'' and the text
  that follows.} the error-revealing
