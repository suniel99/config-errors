...
For error \#14, when JChord crashes, it throws a \CodeIn{ClassNotFoundException}
...
always led directly to the root cause.\todo{Is the same true for
  ConfAnalyzer?  Say explicitly.  Mike wants to review this text once it is
  written.  It would be good to determine, for \emph{every} crashing error
  (not just 8, 9, 10, 11, 13, and 14), whether the program output gives a
  clue as to the configuration option, and maybe even put this in Figure~\ref{tab:results}.}
