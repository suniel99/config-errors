...
\todo{Add the following sentence}
Column ``Rank in Output'' shows the rank of the root cause in the program's
output, in which ``N'' means the program does not output the root cause in this error message.
