...
undesirable behavior to specific configuration options.
...
On average, the root cause was \ourtool's fifth-ranked suggestion, and more
...
%dynamic profiling, and statistical analysis to link the
%erroneous behavior to specific configuration options.}
