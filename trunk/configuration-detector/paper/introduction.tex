...
Our technique (and its tool implementation \ourtool)
can diagnose and correct this problem. We first reproduced the
...
configuration error. \ourtool produced better results for non-crashing errors
and similar results for crashing errors.
% \ourtool produced better results for 8 errors,
