...
which uses information flow anlaysis to reason about the root cause of a
...
techniques to diagnose configuration errors. Our experimental results show
that \ourtool significantly outperforms these two techniques, suggesting
the necessity of designing a new technique (such as \ourtool) for configuration error diagnosis.
