...
\todo{In what sense does $\phi$ ``characterize'' behavior?  What does it
  represent?  What is the intuition?  Right now it's just an arbitrary
  number that you claim works well, but that doesn't convey understanding.}
...
true ratio\todo{``true ratio'' is not defined and could be easily
  misinterpreted as ``the actual ratio'' as opposed to some imprecise ratio}) in a standard way by computing their harmonic mean.
