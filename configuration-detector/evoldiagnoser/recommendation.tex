...
For each predicate in an execution trace,
...
statement. 
\ourtool multiples a predicate's cross-version deviation value 
...
in decreasing order, outputing a ranked list of suspicious
