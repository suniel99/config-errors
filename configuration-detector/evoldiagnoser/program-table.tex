...
\hline
 ...
 \hline
 \hline
 1. Randoop& \CodeIn{usethreads} & \randoopoptnum & \randooprank &  & \x \\
 2. Weka & \CodeIn{m\_numFolds} & \wekaoptnum &  \wekarank & & 1 \\
 3. Synoptic& \CodeIn{dumpInitialGraphDotFile} & \synopticoptnum & \synopticrankfirst &  & \x \\
 4. Synoptic& \CodeIn{dumpInitialGraphPngFile} &\synopticoptnum & \synopticranksecond &  & \x \\
 5. JChord& \CodeIn{chord.ssa} & \jchordoptnum & \jchordrankfirst & & \x \\
 6. JChord& \CodeIn{chord.print.methods} & \jchordoptnum & \jchordranksecond & & \x \\
