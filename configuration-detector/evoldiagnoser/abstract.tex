...
Modern software often expose
a wide range of configuration options for users to
customize its behaviors. During software evolution,
changes can introduce unexpected behavioral differences, 
making the software does not behave as desired.
Often, users need to re-configure the software,
i.e., changing values of certain configuration options,
when using a new software version.
