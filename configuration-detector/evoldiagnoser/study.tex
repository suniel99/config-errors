...
\studysubjnum\todo{The table contains only 8, not 9.} open-source configurable systems used in our
study.
...
\todo{How many total commit messages and change log entries (out of how
  many total) were matched by the search?}
...
software behaviors as having been validated. Further,
because the description of software misconfigurations is user-driven,
