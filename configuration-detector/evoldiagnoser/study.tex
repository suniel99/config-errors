...
We searched \todo{xx} commit messages and \todo{xx} change log entries, in
which \todo{yy} commit messages and \todo{yy} change log entries were matched.
...
on the new version. Among all configuration changes, adding
...
and consequently require users to reconfigure the new software version.
