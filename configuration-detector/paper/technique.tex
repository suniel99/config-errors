...
output, and genertes its dependency set. It compares the dependency sets
...
executes the program on the erreneous inputs with the
...
Intuitively, each vector is capatures the system behavior..
