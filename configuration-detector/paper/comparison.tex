...
\todo{Actually, I performed another variant of coverage analysis (but
did not show the results in the paper): use thin
slicing to compute affected statement, and only monitor coverage of such
affected statements. The results are almost the same. Should I
also mention this? since a reader may question monitoring all
statements introduced the noise.}
