...
one of its affected predicates, the predicate's execution count, and its evaluation results as recorded at run time. For example,
...
% LocalWords:  maxsize ExecutableSequence createNewUniqueSequence newSequence
% LocalWords:  incrExecCount GenInputsAbstract incrTrueCount tuple
