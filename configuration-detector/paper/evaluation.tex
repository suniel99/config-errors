...
\begin{itemize}
  ...
  \item comparison with existing fault localization techniques (Section~\ref{sec:comparison}).
\end{itemize}
...
They are listed in Figure~\ref{tab:errors}. The \noncrash non-crashing errors
...
Second, we only compared two dependence
