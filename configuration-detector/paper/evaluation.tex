...
%
\todo{I don't see why this wouldn't work.  It's just that we haven't
  evaluated this yet, so it would go in threats to validity rather than
  tool limitations.}Third, \ourtool does not yet help diagnose misconfigurations
