...
\phz 4. Synoptic& \CodeIn{partitionRegExp}& 37 & 2 / 6 & 1& 6 & 1 & N &X\\
\phz 5. Soot& \CodeIn{keep\_line\_number} &49 & 1 / 16 & 3 & N & N& N &X\\
\hline
 \multicolumn{2}{|l|}{Average} & 47.2 & 3.6 & 1.6 & 33.5 & 2.5 & 3.5 & X \\
\hline
\hline
...
Column ``ConfAnalyzer'' shows the results of an existing technique~\cite{Rabkin:2011:PPC} (Section~\ref{sec:confanalyzer}).
Columns ``Coverage Analysis'',
and ``Invariant Analysis'' show the results of two fault-localization-based
technique as described in Section~\ref{sec:comparison}.
Column ``Full Slicing'' shows the results of using full slicing to compute
