...
two key aspects: it does \textit{not}
require users to provide a testing oracle (to check whether
the software functions correctly) and thus is fully-automated; and it is
...
\subjectnum configurable software systems. \ourtool identifies the
